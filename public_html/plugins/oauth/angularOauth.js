            ...
            this.$get = function ($q, $http, $window, $rootScope) {
                ...
                var getParams = function () {
                    ...
                    return {
                        ...
                        client_id: '403175311770-hr19ov9lm3c7moosa3k48581mkn1phle.apps.googleusercontent.com',
                        authorizationEndpoint: 'https://accounts.google.com/o/oauth2/auth',
                        redirect_uri: 'http://www.example.com/oauth2callback.html',
                ...
                return {
                    ...
                    verifyAsync: function (accessToken) {
                        ...
                        return $injector.invoke(['$http', '$rootScope', '$q', '$resource', function ($http, $rootScope, $q, $resource) {
                                ...
                                var parametros = {};
                                var method = "GET";
                                verificationEndpoint = 'http://www.googleapis.com/oauth2/v1/tokeninfo';
                                parametros = {access_token: accessToken};
                                //console.log(verificationEndpoint);
                                var req = {method: method, url: verificationEndpoint, headers: {'Content-Type': 'application/x-www-form-urlencoded'}, params: parametros};
                                ...
                                $rootScope.$apply(function () {
                                    ...
                                    $http(req).success(function (data) {
                                        ...
                                        deferred.reject({name: 'error_response', data: data, status: status, headers: headers, config: config});
                                    });
                                });
